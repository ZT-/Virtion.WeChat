...
function() {
    var e, t = function() {},
    o = ["assert", "clear", "count", "debug", "dir", "dirxml", "error", "exception", "group", "groupCollapsed", "groupEnd", "info", "log", "markTimeline", "profile", "profileEnd", "table", "time", "timeEnd", "timeStamp", "trace", "warn"],
    n = o.length;
    0 == /mmdebug/.test(location.search) && location.href.indexOf("dev.web.weixin") < 0 && (window.console = {});
    for (var r = window.console = window.console || {}; n--;) e = o[n],
    r[e] || (r[e] = t)
} (),
...
function() {
    ...
    angular.module("Controllers").controller("appController", ["$rootScope", "$scope", "$timeout", "$log", "$state", "$window", "ngDialog", "mmpop", "appFactory", "loginFactory", "contactFactory", "accountFactory", "chatFactory", "confFactory", "contextMenuFactory", "notificationFactory", "utilFactory", "reportService", "actionTrack", "surviveCheckService", "subscribeMsgService", "stateManageService",
    function(e, t, o, n, r, a, i, c, s, l, u, f, d, g, m, p, h, M, y, C, v, w) {
        ...
        function T() {
            ...
            s.init().then(function(n) {
                if (h.log("initData", n), n.BaseResponse && "0" != n.BaseResponse.Ret) return console.log("BaseResponse.Ret", n.BaseResponse.Ret),
        ...
        function E() {
            t.debug && (k && o.cancel(k), C.start(4e4), k = o(function() {
        ...
        function N(e) {
            ...
            try {
                ...
                f.updateUserInfo(e.Profile,
                function() {}),
                angular.forEach(e.DelContactList,
                function(t) {
                ...
                angular.forEach(e.ModContactList,
                function(t) {
                    u.addContact(t),
                    console.log("ModContactList", e.ModContactList)
                }),
                angular.forEach(e.AddMsgList,
                function(e) {
                    d.messageProcess(e)
                })
            } catch(t) {
        ...
        t.$on("root:searchList:cleanKeyWord",
        function() {
            t.keyword = ""
        });
        var F;
        t.$on("ngDialog.opened",
        function(e, t) {
            w.change("dialog:open", !0),
            F = t,
            b()
        }),
        t.$on("ngDialog.closed",
        function() {
            ...
            function a(i) {
                ...
                case 200:
                    t.newLoginPage(i.redirect_uri).then(function(t) {
                        ...
                        return f ? void(window.location.href = f[1]) : r && "0" != r[1] ? (alert(u && u[1] || "登陆失败"), void location.reload()) : (e.$emit("newLoginPage", {
                            Ret: r && r[1],
                            SKey: i && i[1],
                            Sid: c && c[1],
                            Uin: s && s[1],
...
function() {
    ...
    function(e, t, o, n, r, a, i, c, s, l, u, f, d, g, m, p, h, M, y) {
        ...
        function v(t) {
            for (var o = e.imagesMessagesList,
            n = 0; n < o.length; n++) if (o[n].msg.MsgId == t.MsgId) {
                o.splice(n, 1);
                break
            }
        }
        ...
        e.$on("message:add:success",
        function(t, o) {
            o.MMPeerUserName !== i.getCurrentUserName() && (o._h || e.heightCalc(o,
            function(e) {
                o._h = e
            }))
        }),
        ...
        e.$on("root:msgSend:success",
        function(t, o) {
            if (o.MsgType == u.MSGTYPE_IMAGE && e.imageInit(o), o.ToUserName == e.currentUser) for (var n = 0,
            r = e.chatContent.length; r > n; ++n) {
        ...
        e.previewImg = function(t) {
            ...
            var a = t.MMStatus; (void 0 === a || a == u.MSG_SEND_STATUS_SUCC) && p.open({
        ...
        e.imageInit = function(t, o) {
            for (var n, r, a, i = e.imagesMessagesList,
            c = !1,
            r = e.getMsgImg(t.MsgId), s = 0; s < i.length; s++) if (n = i[s], n.msg === t) {
                c = !0,
                n.url = r,
                a = s;
                break
            ...
            g.toggleOpen({
                ...
                function(o) {
                    ...
                    o.addCharRoomMember = function() {
                        var e = {};
                        angular.forEach(o.currentContact.MemberList,
                        function(t) {
                            e[t.UserName] = t
                        }),
        ...
        var E = !1;
        e.$on("mmRepeat:change",
        function() {
            E && (S.scrollTop = 99999)
        });
        var N, P = !0;
        e.$watchCollection("chatContent",
        function(e) {
            ...
            function(t, o, n, r) {
                setTimeout(function() {
                    ...
                    if (n.MsgType == u.MSGTYPE_EMOTICON || n.MsgType == u.MSGTYPE_IMAGE || n.MsgType == u.MSGTYPE_VIDEO) {
                        ...
                        s = c.height(),
                        l = {};
                        if (console.log("preload!!!!!!!!!!!!!!!!!!!", n, s > 40 || 1 == c[0].complete && !(0 === c[0].naturalWidth) && s > 0, n.ImgHeight), n.ImgHeight) n.MsgType == u.MSGTYPE_EMOTICON ? (l.height = n.ImgHeight * c.width() / n.ImgWidth + "px", l.widht = c.width() + "px") : (l.height = n.ImgHeight, l.width = n.ImgWidth),
                        n.MMImgStyle = l,
                        t.$digest(),
                        r(o.height()),
                        t.$destroy(),
                        o.remove();
                        else if (s > 40 || 1 == c[0].complete && 0 !== c[0].naturalWidth && s > 0) r(o.height()),
                        t.$destroy(),
                        o.remove();
                        else {
                            if (n.MMPreviewSrc) return c[0].onload = a,
                            c[0].onerror = i,
...
function() {
    ...
    function(e, t, o, n, r, a, i, c, s, l, u, f, d, g, m) {
        ...
        function h() {
            window.getSelection ? (A = window.getSelection(), I = A.getRangeAt(0)) : I = document.selection.createRange()
        }
        function M() {
            I ? window.getSelection ? (A.removeAllRanges(), A.addRange(I)) : I.select() : y()
        }
        function y() {
            var e, t;
            document.createRange ? (e = document.createRange(), e.selectNodeContents(U), e.collapse(!1), t = window.getSelection(), t.removeAllRanges(), t.addRange(e)) : document.selection && (e = document.body.createTextRange(), e.moveToElementText(U), e.collapse(!1), e.select())
        }
        function C(e) {
            var t, o, n = "";
            if (window.getSelection) t = window.getSelection(),
            t.rangeCount > 0 && (o = t.getRangeAt(0).cloneRange(), o.collapse(!0), o.setStart(U, 0), n = o.toString().slice( - e));
        ...
        function v(e, t) {
            var o, n;
            if (t || M(), window.getSelection) { ! t && I ? (o = A, n = I) : (o = window.getSelection(), n = o.getRangeAt(0)),
                n.deleteContents();
                var r;
            ...
            } else n = t || !I ? document.selection.createRange() : I,
            e = e.replace(/</gi, "&lt;").replace(/>/gi, "&gt;"),
            n.pasteHTML(e),
            n.select()
        }
        function w() {
            window.getSelection && (window.getSelection().getRangeAt(0).insertNode(F), k = F.offsetLeft, D = F.offsetTop - U.scrollTop, R.appendChild(F))
        }
        function S(t) {
            var o = r.open({
            ...
            function(e) {
                ...
                try {
                    ...
                    function(e) {
                        ...
                        if (0 == e.size) return B.skipFile(e),
                        alert(MM.context("61e885c")),
                        !1;
                        if (e._data = e._data || {},
                        /untitled\d+.png/i.test(e.name)) N(e, z);
                        else if (N(e, W), "gif" !== e.ext.toLowerCase() && !T(e.ext)) {
                            var n = E(e.ext);
                            if (n == a.MSGTYPE_VIDEO && e.size >= 1024 * H * 1024) return B.skipFile(e),
                        ...
                        B.md5File(e).then(function(t) {
                            function n(e, t, o) {
                                ...
                                t ? (B.trigger("fileQueued", e), B.trigger("uploadSuccess", e, o), B.skipFile(e)) : (e._checked = !0, B.addFiles(e))
                            }
                            ...
                            if (r) {
                                ...
                                o({
                                    ...
                                    }), e.Signature = t.Signature, n(e, t.MediaId, t)) : (e.MMSendMsg.MMFileStatus = a.MM_SEND_FILE_STATUS_FAIL, e.MMSendMsg.MMStatus = a.MSG_SEND_STATUS_FAIL, alert(t.BaseResponse.ErrMsg))
                                }).error(function() {
                                    e.MMSendMsg.MMFileStatus = a.MM_SEND_FILE_STATUS_FAIL,
                                    e.MMSendMsg.MMStatus = a.MSG_SEND_STATUS_FAIL,
                                    alert("上传失败")
                                })
                            } else c = angular.extend({},
                            l),
                            n(e)
                        }),
                        !1
        ...
        var A, I, F = document.getElementById("caretPosHelper"),
        k = 0,
        D = 0,
        U = document.getElementById("editArea"),
        R = U.parentNode,
        x = u.getShareObject("editingContents"),
        O = !1;
        $(U).on("input",
        function() {
            h()
        ...
        t.screenShot = function() {
            ...
            l.isSupport() ? l.capture({
                ok: function() {
                    ...
                    e = S(t),
                    l.upload(JSON.stringify(t),
                    function(t) { ! t.BaseResponse || t.BaseResponse && 0 != t.BaseResponse.Ret ? (alert(MM.context("76a7e04")), e.close()) : (console.log("capture upload success"), e.update(a.API_webwxpreview + "?fun=preview&mediaid=" + t.MediaId, t.MediaId))
                    })
                }
        ...
        t.editAreaKeydown = function(e) {
            ...
            if (o == a.KEYCODE_ENTER) {
                if (e.altKey || e.ctrlKey || e.metaKey || e.shiftKey) {
                    ...
                    if (!u.browser.msie && window.getSelection) {
                        ...
                        do
                        if (!r || r.nodeValue || "BR" == r.tagName) break;
            ...
            83 == o && e.altKey && (t.sendTextMessage(), e.preventDefault()),
        ...
        W = {
            onQueued: function() {
                if ("gif" == this.ext.toLowerCase()) return this.MMSendMsg = s.createMessage({
                    MsgType: a.MSGTYPE_EMOTICON,
                    EmojiFlag: a.EMOJI_FLAG_GIF
                }),
                void
                ...
                if (T(this.ext)) {
                    ...
                    function(t) {
                        ...
                        B.makeThumb(t,
                        function(o, n) { (o || !n) && m.report(m.ReportType.uploaderError, {
                                text: "创建缩略图失败",
        ...
        window.WebUploader ? P() : e.$on("root:pageInit:success",
        function() {
            P()
        })
    }])
...
function() {
    ...
    function(e, t, o, n, r, a, i, c, s, l, u, f, d, g, m, p) {
        ...
        t.add = function() {
            ...
            o = [];
            angular.forEach(t.selectedUsers,
            function(e) {
                o.push(e.UserName)
            }),
            l.addMember(e.UserName, o.join(","),
            function(e) {
        ...
        t.create = function() {
            var e = [];
            return angular.forEach(t.selectedUsers,
            function(e, o) {
            ...
            }), void t.closeThisDialog()) : (angular.forEach(t.selectedUsers,
            function(t) {
                e.push({
                    UserName: t.UserName
                })
...
function() {
    ...
    function(e, t, o, n, r, a, i, c, s, l, u, f) {
        ...
        function g(o) {
            t.contextMenuList = [];
            var n = i.getContact(o); (n.isRoomContact() || n.isContact()) && t.contextMenuList.push(n.isTop() ? {
        ...
        t.$on("app:contextMenu:show",
        function(e, t) {
            d(t)
        }),
        t.$on("app:contextMenu:hide",
        function() {
            t.isShowContextMenu = !1
        })
    }])
...
function(_aoUndefined) {
    ...
    function($rootScope, $timeout, $http, $q, contactFactory, accountFactory, emojiFactory, confFactory, notificationFactory, utilFactory, reportService, mmHttp, titleRemind) {
        function handleChatList(e) {
            for (var t, o = [], n = [], r = 0; r < e.length; r++) t = e[r],
        ...
        service = {
            ...
            addChatList: function(e) {
                var t = this;
                e && (angular.isArray(e) || (e = [e]), angular.forEach(e,
                function(e) {
                    var t = "",
                    o = 0;
                    if (t = e.UserName ? e.UserName: e.FromUserName == accountFactory.getUserInfo().UserName ? e.ToUserName: e.FromUserName, o = _chatList.indexOf(t), -1 == o) _chatList.unshift(t),
            ...
            getChatList: function() {
                ...
                angular.forEach(_chatList,
                function(o) {
                    var n, r = contactFactory.getContact(o),
                    a = {}; ! r || r.isBrandContact() || r.isShieldUser() || (o == _currentUserName && e.markMsgsRead(o) && e.notifyMobile(o, confFactory.StatusNotifyCode_READED), n = e._getLastMessage(r.UserName), angular.extend(a, r, {
                        MMDigest: n.MMDigest || "",
            ...
            getChatMessage: function(e, t) {
                var o = this;
                return t && (_currentUserName = e, o.markMsgsRead(e)),
            ...
            markMsgsRead: function(e) {
                for (var t = this.getChatMessage(e), o = !1, n = 0, r = t.length; r > n; n++) t[n].MMUnread && (o = !0),
                t[n].MMUnread = !1;
                return o
            },
            messageProcess: function(e) {
                ...
                if (! (utilFactory.isShieldUser(e.FromUserName) || utilFactory.isShieldUser(e.ToUserName) || e.MsgType == confFactory.MSGTYPE_VERIFYMSG && e.RecommendInfo && e.RecommendInfo.UserName == accountFactory.getUserInfo().UserName)) {
                    ...
                    e.MMIsSend || r && (r.isMuted() || r.isBrandContact()) || e.MsgType == confFactory.MSGTYPE_SYS || (accountFactory.isNotifyOpen() && t._notify(e), accountFactory.isSoundOpen() && utilFactory.initMsgNoticePlayer(confFactory.RES_SOUND_RECEIVE_MSG)),
                    t.addChatMessage(e),
                    t.addChatList([e])
                }
            },
            ...
            _commonMsgProcess: function(e) {
                ...
                utilFactory.isRoomContact(e.MMPeerUserName) ? (e.MMIsChatRoom = !0, r = e.Content.replace(/^(@[a-zA-Z0-9]+|[a-zA-Z0-9_-]+):<br\/>/,
                function(e, t) {
                    return a = t,
                    ""
                }), a && a != accountFactory.getUserName() && (t = contactFactory.getContact(a, e.MMPeerUserName), t && (i = t.getDisplayName(e.MMPeerUserName), i && (e.MMDigest = i + ":")))) : (e.MMIsChatRoom = !1, r = e.Content),
            ...
            _emojiMsgProcess: function(e) {
                var t = this;
                if (e.HasProductId) e.MMActualContent = e.MMIsSend ? "" + MM.context("80f56fb") : MM.context("2242ac7") + "",
                t._textMsgProcess(e);
                else {
            ...
            _systemMsgProcess: function(e) {
                ...
                if (t) for (var o, n, r = 0,
                a = t.length; a > r; ++r) o = /&lt;a href=(?:'|")(.*?)(?:'|").*?&gt;.*?&lt;\/a&gt;/.exec(t[r]),
                o && o[1] && (n = o[1], e.MMActualContent = e.MMActualContent.replace(/&lt;a href=(?:'|")weixin:\/\/.*?&lt;\/a&gt;/, ""));
...
function() {
    ...
    function() {
        ...
        e.indexOf("wx2.qq.com") > -1 ? (t = "login.wx2.qq.com", o = "file.wx2.qq.com", n = "webpush.wx2.qq.com") : e.indexOf("wx8.qq.com") > -1 ? (t = "login.wx8.qq.com", o = "file.wx8.qq.com", n = "webpush.wx8.qq.com") : e.indexOf("qq.com") > -1 ? (t = "login.wx.qq.com", o = "file.wx.qq.com", n = "webpush.wx.qq.com") : e.indexOf("web2.wechat.com") > -1 ? (t = "login.web2.wechat.com", o = "file.web2.wechat.com", n = "webpush.web2.wechat.com") : e.indexOf("wechat.com") > -1 && (t = "login.web.wechat.com", o = "file.web.wechat.com", n = "webpush.web.wechat.com");
    ...
    function(e, t, o, n, r, a, i, c, s, l, u) {
        ...
        P = {
            ...
            isInChatroom: function() {
                var e = this;
                return 0 == this.MemberList.length && 0 != this.ContactFlag ? !0 : e.MMInChatroom === !1 || e.MMInChatroom === !0 ? e.MMInChatroom: (angular.forEach(this.MemberList,
                function(t) {
            ...
            getDisplayName: function(e) {
                var t = this,
                o = "";
                if (c.isRoomContact(t.UserName)) if (o = t.RemarkName || t.NickName, !o && t.MemberList) for (var n = 0,
                r = t.MemberList.length; r > n && 10 > n; ++n) {
                    o.length > 0 && (o += ", ");
            ...
            chatroomCanSearch: function(e) {
                if (this.isRoomContact()) {
                    ...
                    for (var t = 0,
                    o = this.MemberList.length; o > t; t++) {
            ...
            canSearch: function(e) {
                ...
                c >= 0 || s >= 0 ? !0 : (c = n.toUpperCase().indexOf(e), s = r.toUpperCase().indexOf(e), c >= 0 || s >= 0 ? !0 : a.toUpperCase().indexOf(e) >= 0 ? !0 : i.toUpperCase().indexOf(e) >= 0 ? !0 : !1)
            },
            update: function(e) {
        ...
        A = {
            ...
            inContactsWithErrorToGetList: function(e) {
                for (var t = 0,
                o = S.length; o > t; t++) if (S[t].UserName == e.UserName) return t;
                return - 1
            },
            inContactsToGetList: function(e) {
                for (var t = 0,
                o = v.length; o > t; t++) if (v[t].UserName == e.UserName) return t;
                return - 1
            },
            inContactsGettingList: function(e) {
                for (var t = 0,
                o = w.length; o > t; t++) if (w[t].UserName == e.UserName) return t;
                return - 1
            },
            ...
            addBatchgetContact: function(e, t, r) {
                function i(e) {
                    ...
                    angular.forEach(e.ContactList,
                    function(e) {
                        var t = d.inContactsToGetList({
                            UserName: e.UserName
                        });
                        t > -1 && v.splice(t, 1),
                        c.isRoomContact(e.UserName) && e.MemberList && e.MemberList.length ? angular.forEach(e.MemberList,
                        function(t) {
                ...
                function s(e) {
                    ...
                    E++,
                    f.reject(e),
                    1 == t.length ? (console.log("batchGetContactError", t[0]), b[t[0].UserName] = 1) : angular.forEach(t,
                    function(e) {
            ...
            addBatchgetChatroomMembersContact: function(e) {
                var t = this,
                o = t.getContact(e);
                o && o.isRoomContact() && !o.MMBatchgetMember && o.MemberList.length > 0 && (o.MMBatchgetMember = !0, angular.forEach(o.MemberList,
                function(e) {
            ...
            batchGetContact: function(e) {
                var n = o.defer(),
                i = 1;
                return S.length ? (i = S.length < 6 || E > 2 ? 1 : S.length < 40 ? 5 : 10, w = S.splice(0, i), console.log("_contactsWithErrorToGetList lenght:", S.length)) : w = v.splice(0, 50),
                t({
                    method: "POST",
            ...
            getChatRoomMembersContact: function(e, t) {
                ...
                n = g[e],
                r = [];
                return n ? (angular.forEach(n.MemberList,
                function(e) {
            ...
            remoteSearch: function(e) {
                function n(e) {
                    for (var t, o, n = [], r = 0; r < e.length; r++) t = e[r].EncryUserName,
                    o = g[t],
            ...
            pickContacts: function(e, t, o) {
                for (var n, r, a, i = [], c = this, s = t.all || {},
                l = 0; l < e.length; l++) switch (n = e[l], a = t[n] || {},
                a = $.extend({},
                a, s), n) {
                case "star":
                ...
                case "friend":
                    if (r = c.getAllFriendContact(a), r.length > 0) {
                        ...
                        var u = "";
                        a.showFriendHeader || a.noHeader || angular.forEach(r,
                        function(e, t) {
                            if (e.MMOrderSymbol) {
...
function() {
    ...
    function(e, t, o) {
        function n(e, t, o, n) {
            var r; (r = l[e]) ? (r.intervalSum += o, n && n <= r.intervalSum && (setTimeout(t, 0), l[e].intervalSum = 0), clearTimeout(r.timer), r.timer = setTimeout(function() {
                delete l[e],
                setTimeout(t, 0)
            },
        ...
        var u = {
            ...
            getCookie: function(e) {
                for (var t = e + "=",
                o = document.cookie.split(";"), n = 0; n < o.length; n++) {
                    for (var r = o[n];
            ...
            hrefEncode: function(e) {
                ...
                if (o) {
                    for (var n, r, a = 0,
                    c = o.length; c > a; ++a) n = /&lt;a href=(?:'|")(.*?)(?:'|").*?&gt;.*?&lt;\/a&gt;/.exec(o[a]),
                    n && n[1] && (r = n[1], t.isUrl(r) && (e = e.replace(n[0], this.htmlDecode(n[0])).replace(n[1], u.genCheckURL(n[1]))));
                    return e
                }
                return e.replace(new RegExp(i, "ig"),
                function() {
            ...
            isSpUser: function(e) {
                for (var t = 0,
                o = c.length; o > t; t++) if (c[t] === e || /@qqim$/.test(e)) return ! 0;
                return ! 1
            },
            isShieldUser: function(e) {
                if (/@lbsroom$/.test(e) || /@talkroom$/.test(e)) return ! 0;
                for (var t = 0,
                o = s.length; o > t; ++t) if (s[t] == e) return ! 0;
                return ! 1
            },
            ...
            queryParser: function() {
                for (var e = {},
                t = location.search.substring(1), o = t.split("&"), n = 0, r = o.length; r > n; n++) {
                    var a = o[n].split("="),
    ...
    function(e, t, o, n) {
        var r = {
            formatHTMLToSend: function(e) {
                var t = this;
                return n.htmlDecode(n.clearHtmlStr(e.replace(/<(?:img|IMG).*?text="(.*?)".*?>/g,
                function(e, t) {
            ...
            transformSpanToImg: function(e) {
                var t = this;
                return e && e.replace(/<span.*?class="emoji emoji(.*?)"><\/span>/g,
                function() {
            ...
            emoticonFormat: function(e) {
                var t = this;
                return 0 == e.length ? "": (e = e.replace(new RegExp("(\\[.+?\\])(?!" + o.MM_EMOTICON_WEB + ")", "g"),
                function(e, o) {
                    return t.getEmoticonByText(o) || e
                }).replace(new RegExp("&lt;(.+?)&gt;(?!" + o.MM_EMOTICON_WEB + ")", "g"),
                function(e, o) {
                    return t.getEmoticonByText("<" + o + ">") || e
...
function() {
    ...
    function(e, t) {
        ...
        function i(o, r) {
            ...
            i.ClearHeaders(),
            i.ClearFormItems(),
            i && (i.URL = (MMDEV ? "http://wx.qq.com": "http://" + location.hostname) + e.API_webwxpreview + "?fun=upload", i.AddHeader("Cookie", document.cookie), i.AddFormItem("msgimgrequest", 0, 0, o), i.AddFormItem("filename", 1, 4, a()), i.OnEvent = function(e, o) {
                switch (o) {
                case 2:
                    break;
                case 3:
...
function() {
    ...
    function(e) {
        ...
        function c(e, n) {
            ...
            c = o(a),
            h.push(c),
            M.autoClose && a && !a.ieVerification && a.addEventListener && a.addEventListener("show",
            function() {
                var e = c;
                setTimeout(function() {
                    e.close()
...
function() {
    ...
    function() {
        function e(e) {
            if ("object" == typeof e) for (var n in e) o[n] !== e[n] && t(n, e[n]),
            o[n] = e[n]
        }
        function t(e, t) {
            var o = n[e];
...
function() {
    ...
    function(e, t, o, n) {
        ...
        function p(e, t) {
            _.push(e),
            t ? h() : (y && clearTimeout(y), y = setTimeout(function() {
                h()
            },
            C))
        }
...
function() {
    ...
    function(e, t, o) {
        function n(n) {
            ...
            function i() {
                C++,
                l.complete || (l.complete = !0, y.resolve(), a(p, this, arguments))
            }
            function c() {
                C++,
        ...
        i = ["post", "get", "jsonp"], c = 0; c < i.length; c++) r = i[c],
        a[r] = function(t) {
            return function(o) {
                var r, a, i = [o];
                ...
                var c;
                r && i.push(r),
                a && (c = "undefined" != typeof a.MMRetry, i.push(a));
                var s;
                return s = c ? n({
                    args: i,
                    method: t,
...
function() {
    ...
    function(e) {
        function t(e, t) {
            ...
            var r, a;
            "undefined" != typeof n.hidden ? (r = "hidden", a = "visibilitychange") : "undefined" != typeof n.mozHidden ? (r = "mozHidden", a = "mozvisibilitychange") : "undefined" != typeof n.msHidden ? (r = "msHidden", a = "msvisibilitychange") : "undefined" != typeof n.webkitHidden && (r = "webkitHidden", a = "webkitvisibilitychange"),
    ...
    function(a, i, c, s, l, u, f, d, g, m) {
        ...
        h = {
            ...
            performClosePop: function(e, t) {
                var o = e.attr("id"),
                i = e.scope();
                i && !i.closing && (i.closing = !0, e.unbind("click"), 1 === n && p.unbind("keydown"), u.$broadcast("root:mmpop:closing", o), m.leave(e,
                function() {
            ...
            if (a) {
                ...
                function() {
                    ...
                    s = setTimeout(function() {
                        ...
                        u = -1,
                        f = 0,
                        d = c.length; d > f && ( - 1 == l && r.substr(f, 1) != c.substr(f, 1) && (l = f), -1 == u && r.substr(r.length - f - 1, 1) != c.substr(c.length - f - 1, 1) && (u = f), !( - 1 != l && -1 != u || l >= d - 1 - u)); ++f);
                        if ( - 1 != l && -1 != u) {
                            if (u = d - 1 - u, l >= u) {
                                f = l;
                            ...
                            var _ = i(m).replace(/&nbsp;/g, " ").replace(new RegExp("<(?!br|" + o.EMOTICON_REG + ").*?>", "g"), "").replace(new RegExp("&lt;(br|" + o.EMOTICON_REG + "/?)&gt;", "g"), "<$1>").replace(/<img.*?class="(.*?)" text="(.*?)" .*?>/g,
                            function() {
                    ...
                    function() {
                        jQuery(r).jPlayer({
                            ready: function() {
                                ...
                                a.loop !== e && f && (jQuery(this).jPlayer("play"), c())
                            },
                            click: function() {
    ...
    return {
        ...
        link: function(n, r) {
            ...
            function u() {
                ...
                function(e) {
                    var t, o = e.originalEvent; ("mousewheel" == o.type || "DOMMouseScroll" == o.type) && (t = o.wheelDelta ? o.wheelDelta / 120 : -(o.detail || 0) / 3),
                    void 0 !== t && (c(N ? {
                        delta: t
                    }: {
                        delta: t,
...
angular.module("Directives").directive("mmlazyDirective",
function() {
    return {
        restrict: "A",
        link: function(e, t) {
...
}).directive("mmlazyWithScrollbarDirective",
function(e) {
    return {
        restrict: "A",
        link: function(t, o) {
...
angular.module("jQueryScrollbar", []).directive("jqueryScrollbar",
function() {
    return {
        link: function(e, t) {
            setTimeout(function() {
            ...
            var _ = {
                ...
                performCloseDialog: function(t, o) {
                    ...
                    function() {
                        t.scope().$destroy(),
                        t.remove(),
                        0 === s && (C.removeClass("ngdialog-open"), _.resetBodyPadding()),
                        p.$broadcast("ngDialog.closed", t)
                    }).addClass("ngdialog-closing") : (t.scope().$destroy(), t.remove(), 0 === s && (C.removeClass("ngdialog-open"), _.resetBodyPadding()), p.$broadcast("ngDialog.closed", t)),
                    l[r] && (l[r].resolve({
                        id: r,
                        value: o,
                        $dialog: t,
            ...
            v = {
                open: function(a) {
                    ...
                    return g.when(c(w.template || w.templateUrl)).then(function(t) {
                        ...
                        }), w.closeByEscape && C.bind("keydown", _.onDocumentKeydown), w.closeByNavigation && p.$on("$locationChangeSuccess",
                        function() {
                            _.closeDialog(b)
                        }), n = function(e) {
                            var t = w.closeByDocument ? o(e.target).hasClass("ngdialog-overlay") : !1,
                            n = o(e.target).hasClass("ngdialog-close"); (t || n) && v.close(b.attr("id"), n ? "$closeButton": "$document")
                        },
...
function(e, t) {
    ...
    function r(e, t, r, a) {
        ...
        return f > 0 ? (u = o(e, 0, 0, f, a), i = u.index, f = u.total) : (i = 0, f = 0),
        c = o(e, i, f, d, a).index,
    ...
    function i(e) {
        if (! (e.length <= 0)) for (var t, o = 0,
        n = 0; n < e.length; n++) t = e[n],
        t._offsetTop = o,
        o += t._h
    }
    function c(e, t, o) {
        if (! (e.length <= 0)) for (var n, r = 0; r < e.length; r++) n = e[r],
        (!n._h || o) && (n._h = t(n))
    }
    function s(e, t, o) {
        var n = function(e) {
        ...
        for (var r, a = e.length,
        i = 0,
        c = 0; a > c; c++) r = e[c],
        r._h ? (i++, i == a && n(e)) : (console.log("pre", "callcalc"), t(r,
        function(t) {
            return function(o) {
                t._h = o,
                t._calcing = !1,
    ...
    return {
        ...
        link: function(e, o, n) {
            ...
            function(t, o) {
                return u = o.y,
                e.heightCalc && 2 === e.heightCalc.length && !l(r) ? void s(r, e.heightCalc,
                function() {
                    l(r) && (i(r), a(e, u, e[d], r), e.$digest())
                }) : (a(e, u, e[d], r), void e.$digest())
            }),
            e.$parent.$watch(n.heightCalc,
            function(t) {
            ...
            e.$parent.$watchCollection(f[2],
            function(t) {
                if (t instanceof Array) if (r = t, t.length > 0) {
                    for (var o = 0; o < r.length; o++) r[o]._index = o;
                    console.time("calc"),
                    e.preCalc ? s(r, e.heightCalc,
                    function() {
                        console.timeEnd("calc"),
                        console.time("render"),
                        l(r) && (i(r), a(e, u, e[d], r), e.$digest(), e.$emit("mmRepeat:change"))
                    ...
                    if (g) {
                        ...
                        if (c) {
                            ...
                            case o.KEYCODE_ARROW_UP:
                                do c = c._index - 1 < 0 ? g: u[c._index - 1];
                                while (!n(c));
                                c == g && (r = !0);
                                break;
                            case o.KEYCODE_ARROW_DOWN:
                                do c = c._index + 1 >= u.length ? g: u[c._index + 1];
                                while (!n(c));
                                break;
                            default:
                                return
...
angular.module("Directives").directive("searchListDirective", [function() {
    return {
        ...
        link: function(e, t) {
            ...
            n.length - 1,
            e.selectIndex = a,
            e.$on("root:searchList:keyArrowUp",
            function() {
                var t = e.selectIndex;
                do--t;
            ...
            e.$on("root:searchList:keyArrowDown",
            function() {
                var t = n.length - 1,
                r = e.selectIndex;
                do++r;
        ...
        link: function(t) {
            function o(e) {
                ...
                if (f.canDo("navKeydown")) {
                    if (t.currentUserName) o = n(s, t.currentUserName),
                    c = o,
                    u.wait(function() {
            ...
            t.$on("app:chat:dblclick",
            function() {}),
            t.$on("root:deleteChat",
            function(e, t) {
                a.deleteChatList(t),
                a.deleteChatMessage(t),
                a.getCurrentUserName() == t && a.setCurrentUserName("")
            }),
            t.$on("root:msgSend:success",
            function(e, o) {
                var n = o.ToUserName;
                angular.forEach(t.chatList,
                function(e) {
                    ...
                    function() {
                        if (n) if (t.ctrlKey) {
                            ...
                            case a.KEYCODE_ARROW_UP:
                                do s = s._index - 1 < 0 ? n: o[s._index - 1];
                            ...
                            case a.KEYCODE_ARROW_UP:
                                ...
                                break;
                            case a.KEYCODE_ARROW_DOWN:
                                do s = s._index + 1 >= o.length ? n: o[s._index + 1];
                                while ("undefined" == typeof s.NickName);
                                break;
                            default:
                                return
...
function(e, t, o, n, r, a, i, c, s, l, u, f, d, g) {
    function m(e) {
        for (var t, o = [], n = 0; n < e.length; n++) t = e[n],
        o.push(t),
...
function(e, t) {
    return {
        ...
        link: function(e, o, n) {
            function r() {
                for (var t; t = y.pop();) delete t.src,
                t.onload = null,
                t.onerror = null;
                _ && e[_] && e[_].call(o)
            }
            function a(t) {
                p.onerror = null,
                p.onload = null,
                c() || (console.log(t), n.$set(u, f), v && e[v] && e[v].call(o))
            }
            function i() {
                M = !1,
                p.onload = function() {
...
function(e, t, o, n, r, a, i, c, s, l, u, f) {
    ...
    return {
        ...
        link: function(t, o) {
            function n(e) {
                var o = -1;
                return angular.forEach(t.selectList,
                function(t, n) {
            ...
            function i(e) { (!t.current || e) && t.contactList.length > 0 && t.keyword && a("header" == t.contactList[0].type ? t.contactList[1] : t.contactList[0])
            }
            var s;
            t.$watch(function() {
            ...
            t.search = function() {
                ...
                g = e(function() {
                    if (t.keyword) {
                        ...
                        i(!0)
                    } else t.contactList = r(c.pickContacts(p.types, p.opt, !0).result, h),
                    i(!0)
                },
                200)
            },
...
function(e, t) {
    "use strict";
    t.module("ngClipboard", []).provider("ngClip",
    function() {
        var e = this;
    ...
    function(o, n) {
        ...
        e.ZeroClipboard ? r() : o.$on("root:pageInit:success",
        function() {
            r()
        })
    ...
    function() {
        return {
            ...
            link: function(e, o, n) {
                ...
                if (r.isFlashUnusable()) return void o.bind("click",
                function(t) {
...
function() {
    "use strict";
    angular.module("Filters").filter("HTMLEnCode",
    function() {}).filter("HTMLDeCode",
    function() {
        return function(e) {
            return 0 == e.length ? "": e = e.replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&#39;/g, "'").replace(/&quot;/g, '"').replace(/&amp;/g, "&")
        }
    }).filter("VoiceLengthFilter",
    function() {
        return function(e) {
            return 0 == e.length ? 0 : Math.round(e / 1e3)
        }
    }).filter("emojiHideFilter",
    function() {
        return function(e) {
...
function() {
    ...
    function(e) {
        return function(t) {
            return 0 == t.length ? "": t = t.replace(/\[([^\]]+)\]/g,
            function(t, o) {
...
function() {
    ...
    function f(e) {
        ...
        r = "";
        for (o = 0; o < e.length; o += 1) t = e.charCodeAt(o),
